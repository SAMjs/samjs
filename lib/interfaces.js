  ...
  module.exports = function(samjs) {
    ...
    return samjs.interfaces = new (Interfaces = (function() {
      ...
      Interfaces.prototype.expose = function(name) {
        var exposeInterface, exposeInterfaces, i, interfaces, j, len, len1, model, modelname, plugin, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7;
          ...
          return function(interfaces, name) {
            ...
            if (samjs.util.isArray(interfaces)) {
              ...
              for (i = 0, len = interfaces.length; i < len; i++) {
                itf = interfaces[i];
                results.push(_this._closers[name].push(exposeInterface(itf.bind(_this), name)));
              }
              return results;
            } else {
              return _this._closers[name].push(exposeInterface(interfaces.bind(_this), name));
            }
          };
        })(this);
        if (name) {
          if (this._interfaces[name] != null) {
            ...
            for (i = 0, len = ref1.length; i < len; i++) {
              plugin = ref1[i];
              if (((ref2 = plugin.interfaces) != null ? ref2[name] : void 0) != null) {
                exposeInterfaces(plugin.interfaces[name], name);
              }
            }
          }
        } else {
          ref3 = this._interfaces;
          for (name in ref3) {
            interfaces = ref3[name];
            exposeInterfaces(interfaces, name);
          }
          ref4 = samjs.models;
          for (modelname in ref4) {
            model = ref4[modelname];
            ref5 = model.interfaces;
            for (name in ref5) {
              interfaces = ref5[name];
              exposeInterfaces(interfaces, name);
            }
          }
          ref6 = samjs._plugins;
          for (j = 0, len1 = ref6.length; j < len1; j++) {
            ...
            if (plugin.interfaces != null) {
              ref7 = plugin.interfaces;
              for (name in ref7) {
                interfaces = ref7[name];
                exposeInterfaces(interfaces, name);
              }
            }
          }
