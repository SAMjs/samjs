  ...
  module.exports = function(samjs) {
    ...
    listener = function(socket) {
      ...
      socket.on(this.name + ".test", (function(_this) {
        return function(request) {
          if (((request != null ? request.content : void 0) != null) && (request.token != null)) {
            return _this.test.bind(_this)(request.content, socket.client).then(function(info) {
              return {
                success: true,
                content: info
              };
      ...
      socket.on(this.name + ".get", (function(_this) {
        return function(request) {
          if ((request != null ? request.token : void 0) != null) {
            return _this.get.bind(_this)(socket.client).then(function(response) {
              return {
                success: true,
                content: response
              };
      ...
      return socket.on(this.name + ".set", (function(_this) {
        return function(request) {
          if (((request != null ? request.content : void 0) != null) && (request.token != null)) {
            return _this.set.bind(_this)(request.content, socket.client).then(function(response) {
